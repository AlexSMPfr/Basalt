...
public class EnumRegistryRewriter<T> extends EnumRewriter<Holder.Reference<T>> {
    ...
    @Deprecated
    public static <T> EnumRegistryRewriter<T> forLegacyEnum(ResourceKey<? extends Registry<T>> registryKey) { // get the key from the name of the enum
        return new EnumRegistryRewriter<>(registryKey, false);
    }
